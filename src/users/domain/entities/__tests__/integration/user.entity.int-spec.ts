...
describe('UserEntity integration tests', () => {
  describe('Constructor method', () => {
    it('Should thow an error when creating a user with invalid name', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        name: null,
      }
    ...
    it('Should thow an error when creating a user with invalid email', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        email: null,
      }
    ...
    it('Should thow an error when creating a user with invalid password', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        password: null,
      }
    ...
    it('Should thow an error when creating a user with invalid createdAt', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
  ...
  describe('Update name method', () => {
    it('Should thow an error when update a user with invalid name', () => {
  ...
  describe('Update password method', () => {
    it('Should thow an error when update a user with invalid password', () => {
      const entity = new UserEntity(UserDataBuilder({}))
